...
const API_BASE_URL = "https://efbede333ccb.ngrok-free.app/";
...
export default function BuyerDashboardScreen() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const bidsResponse = await fetch(
        `${API_BASE_URL}/bids?email=${user.email}`
      );
      if (!bidsResponse.ok) {
      ...
      for (const bid of processedBids) {
        try {
          const listingResponse = await fetch(
            `${API_BASE_URL}/listing/${bid.listing_id}`
          );
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      default:
        return (
          <AlertCircle width={16} height={16} stroke={colors.textSecondary} />
        );
    }
  };
        ...
        <View style={styles.header}>
          ...
          <View style={{ flexDirection: "row" }}>
            <TouchableOpacity
              ...
              style={[
                styles.logoutButton,
                { backgroundColor: colors.error + "15", marginRight: 8 },
              ]}
            >
        ...
        <View style={styles.section}>
          ...
          <View style={styles.statsGrid}>
            ...
            >
              ...
              <Typography
                variant="subheading"
                style={[styles.statGridValue, { color: colors.primary }]}
              >
                ₹
                {recentBids
                  .reduce(
                    (sum, bid) => sum + bid.quantity * bid.price_per_kg,
                    0
                  )
                  .toLocaleString()}
              </Typography>
            ...
            >
              ...
              <Typography
                variant="subheading"
                style={[styles.statGridValue, { color: colors.success }]}
              >
                {recentBids
            ...
            >
              ...
              <Typography
                variant="subheading"
                style={[styles.statGridValue, { color: colors.warning }]}
              >
            ...
            >
              ...
              <Typography
                variant="subheading"
                style={[styles.statGridValue, { color: colors.info }]}
              >
